...
<br>&nbsp;<br> 
<aui:form method="post" enctype="multipart/form-data" action="${actionUrl}">
	...
	<br>
	<aui:button type="submit" value="Submit synchronously!"/>
	<aui:button type="button" id='<%=renderResponse.getNamespace() + "ajax"%>' value="Submit with AJAX!"/> 
</aui:form> 
