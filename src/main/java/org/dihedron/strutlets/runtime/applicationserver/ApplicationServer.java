...
public interface ApplicationServer {
	...
	/**
	 * Returns the name of the supported application server.
	 * 
	 * @return
	 *   the name of the supported application server.
	 */
	public String getName();
	
	/**
	 * Returns whether the current concrete instance of application server
	 * runtime is appropriate for the environment it is being run on.
	 *  
	 * @return
	 *   <code>true</code> if the underlying application server is supported 
	 *   by this <code>ApplicationServer</code> plugin, <code>false</code> 
	 *   otherwise. 
	 */
